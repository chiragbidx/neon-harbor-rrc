  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        ...
        description: "Start organizing your customer relationships.",
        cta: "Create Account",
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                All your customers, deals, and teamwork in one CRM.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Modern CRM for teams, with secure authentication and a beautiful dashboard experience.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl border border-secondary/70 bg-background/80 p-3 shadow-lg">
              <Image
                ...
                alt="ClientFlow product preview"
              ...
              {mode === "signin" ? (
                <form className="space-y-4" action={signInAction}>
                  ...
                  <Button type="submit" className="w-full" disabled={isPending}>
                    {isPending ? "Signing in..." : content.cta}
                  </Button>
                </form>
              ) : (
                <form className="space-y-4" action={signUpAction}>
                  ...
                  <Button type="submit" className="w-full" disabled={isPending}>
                    {isPending ? "Creating account..." : content.cta}
                  </Button>
                </form>
              )}
              ...
              <div className="text-center text-sm mt-2">
                {mode === "signin" ? (
                  <span>
                    {content.helper}{" "}
                    <button
                      className="inline underline text-primary cursor-pointer font-medium"
                      type="button"
                      onClick={() => setModeWithHash("signup")}
                    >
                      Get Started Free
